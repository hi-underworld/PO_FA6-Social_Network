...
# This is version of scrape is used for the mention_account.
def scrape(since, until=None, words=None, to_account=None, from_accounts=None, mention_accounts=None, interval=5, lang=None,
    ...
    for from_account in from_accounts:
        for mention_account in mention_accounts:
            since = since_bak
            # ------------------------- Variables :
            # header of csv
            ...
            # ------------------------- settings :
            # file path
            path = save_dir + "/" + from_account + '_' + mention_account + '_' + str(since).split(' ')[0] + '_' + \
                   str(until).split(' ')[
                       0] + '.csv'
...
# # This is version of scrape is used for the from_to_account.
# def scrape(since, until=None, words=None, to_accounts=None, from_accounts=None, mention_account=None, interval=5, lang=None,
#           headless=True, limit=float("inf"), display_type="Top", resume=False, proxy=None, hashtag=None,
#           show_images=False, save_images=False, save_dir="outputs", filter_replies=False, proximity=False):
#     """
#     scrape data from twitter using requests, starting from <since> until <until>. The program make a search between each <since> and <until_local>
...
#             # ------------------------- settings :
#             # file path
#             path = save_dir + "/" + from_account + '_' + to_account + '_' + str(since).split(' ')[0] + '_' + str(until).split(' ')[
#                 0] + '.csv'
# 
# 
#             # if words:
